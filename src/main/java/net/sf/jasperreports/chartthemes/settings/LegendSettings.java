...
public class LegendSettings implements JRChangeEventsSupport, Serializable {
	...
	public void setShowLegend(Boolean showLegend) {
		...
		getEventSupport().firePropertyChange(PROPERTY_showLegend, old,
				getShowLegend());
	}
	...
	public void setForegroundPaint(PaintProvider foregroundPaint) {
		...
		getEventSupport().firePropertyChange(PROPERTY_foregroundPaint, old,
				getForegroundPaint());
	}
	...
	public void setHorizontalAlignment(HorizontalAlignment horizontalAlignment) {
		...
		getEventSupport().firePropertyChange(PROPERTY_horizontalAlignment, old,
	...
	public void setPosition(EdgeEnum positionValue) {
		...
		getEventSupport().firePropertyChange(PROPERTY_position, old,
				this.positionValue);
	}
	...
	public void setVerticalAlignment(VerticalAlignment verticalAlignment) {
		...
		getEventSupport().firePropertyChange(PROPERTY_verticalAlignment, old,
	...
	public void setBorder(Float border) {
		Float old = getBorder();
		this.border = border;
		getEventSupport().firePropertyChange(PROPERTY_border, old, border);
	}
}
