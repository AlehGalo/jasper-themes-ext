 ...
 * @version $Id: AxisSettings.java 7197 2014-08-27 11:59:50Z teodord $
 */
public class AxisSettings implements JRChangeEventsSupport, Serializable {
	...
	public static final String PROPERTY_tickLabelFormat = "tickLabelFormat";
	...
	/**
	 * @param visible
	 *            the visible property to set
	 */
	public void setVisible(Boolean visible) {
		Boolean old = getVisible();
		this.visible = visible;
		getEventSupport().firePropertyChange(PROPERTY_visible, old,
				getVisible());
	}
	...
	public void setLocation(AxisLocation location) {
		...
		getEventSupport().firePropertyChange(PROPERTY_location, old,
				getLocation());
	}
	...
	/**
	 * @param lineVisible
	 *            the lineVisible to set
	 */
	public void setLineVisible(Boolean lineVisible) {
		Boolean old = getLineVisible();
		this.lineVisible = lineVisible;
		getEventSupport().firePropertyChange(PROPERTY_lineVisible, old,
				getLineVisible());
	}
	...
	public void setLabelAngle(Double labelAngle) {
		...
		getEventSupport().firePropertyChange(PROPERTY_labelAngle, old,
				getLabelAngle());
	}
	...
	public void setLabelPaint(PaintProvider labelPaint) {
		...
		getEventSupport().firePropertyChange(PROPERTY_labelPaint, old,
				getLabelPaint());
	}
	...
	public void setLabelFont(JRFont labelFont) {
		...
		getEventSupport().firePropertyChange(PROPERTY_labelFont, old,
				getLabelFont());
	}
	...
	public void setLabelInsets(RectangleInsets labelInsets) {
		...
		getEventSupport().firePropertyChange(PROPERTY_labelInsets, old,
				getLabelInsets());
	}
	...
	/**
	 * @param labelVisible
	 *            the labelVisible to set
	 */
	public void setLabelVisible(Boolean labelVisible) {
		Boolean old = getLabelVisible();
		this.labelVisible = labelVisible;
		getEventSupport().firePropertyChange(PROPERTY_labelVisible, old,
				getLabelVisible());
	}
	...
	public void setTickLabelPaint(PaintProvider tickLabelPaint) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickLabelPaint, old,
				getTickLabelPaint());
	}
	...
	public void setTickLabelInsets(RectangleInsets tickLabelInsets) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickLabelInsets, old,
				getTickLabelInsets());
	}
	...
	public void setTickLabelsVisible(Boolean tickLabelsVisible) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickLabelsVisible, old,
	...
	/**
	 * @param tickMarksInsideLength
	 *            the tickMarksInsideLength to set
	 */
	public void setTickMarksInsideLength(Float tickMarksInsideLength) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickMarksInsideLength,
				old, getTickMarksInsideLength());
	}
	...
	/**
	 * @param tickMarksOutsideLength
	 *            the tickMarksOutsideLength to set
	 */
	public void setTickMarksOutsideLength(Float tickMarksOutsideLength) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickMarksOutsideLength,
				old, getTickMarksOutsideLength());
	}
	...
	/**
	 * @param tickMarksPaint
	 *            the tickMarksPaint to set
	 */
	public void setTickMarksPaint(PaintProvider tickMarksPaint) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickMarksPaint, old,
				getTickMarksPaint());
	}
	...
	public void setTickMarksVisible(Boolean tickMarksVisible) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickMarksVisible, old,
				getTickMarksVisible());
	}
	...
	public void setTickCount(Integer tickCount) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickCount, old,
				getTickCount());
	}
	...
	public void setTickInterval(Number tickInterval) {
		...
		getEventSupport().firePropertyChange(PROPERTY_tickInterval, old,
				getTickInterval());
	}
	...
	public void setLineStroke(Stroke lineStroke) {
		...
		getEventSupport().firePropertyChange(PROPERTY_lineStroke, old,
				getLineStroke());
	}
	 ...
	 *            the tickLabelFormat to set
	 */
	public void setTickLabelFormat(String tickLabelFormat) {
		String old = getTickLabelFormat();
		this.tickLabelFormat = tickLabelFormat;
		getEventSupport().firePropertyChange(PROPERTY_tickLabelFormat, old,
				getTickLabelFormat());
		this.tickLabelFormat = tickLabelFormat;
	}
}
